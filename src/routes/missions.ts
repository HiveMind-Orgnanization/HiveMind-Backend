      ...
      switch (role) {
        ...
        case "Development":
          return [
            ...
            "",
            "Default frontend stack: Tailwind CSS (`tailwindcss` + `postcss` + `autoprefixer`, or `@tailwindcss/vite`), `tailwind.config.*`, postcss wiring, `@tailwind` directives in the CSS entry, and utility classes throughout TSX. Never ship a bare unstyled page.",
